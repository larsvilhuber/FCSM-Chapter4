...
\usepackage[style=chicago-authordate,sorting=ydnt,maxnames=10,backend=biber,natbib]{biblatex}
...
\def\DR{\ensuremath{\mathbf{R}}} %% Disclosure risk
\def\DU{\ensuremath{\mathbf{U}}} %% Data utility
\def\DD{\ensuremath{\mathbf{DD}}} %% Data distortion
\def\RS{\ensuremath{\mathbf{R}}} %% Release space
\def\MS{\ensuremath{\mathbf{M}}} %% Release space
...
\newglossaryentry{rounding}
{
    name=rounding,
    description=See \gls{perturbation-based Methods}
    }
